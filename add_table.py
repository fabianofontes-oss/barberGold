            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse min-w-[800px]">
                ...
                <tbody className="divide-y divide-white/5 text-sm text-gray-300">
                  ...
                  <tr className="bg-white/[0.02]">
                    <td className="py-3 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider" colSpan={4}>Financeiro & Lucro</td>
                  </tr>
                  <tr className="hover:bg-white/5 transition-colors group">
                  ...
                  <tr className="bg-[#18181b]">
                    ...
                    <td className="p-5 text-center border-r border-white/5">
                      <Link href="/register" className="block w-full bg-white/5 hover:bg-white/10 text-white text-xs font-bold py-2 rounded transition-colors">Escolher Start</Link>
                    </td>
                    <td className="p-5 text-center border-r border-white/5 bg-[#202024]/50">
                      <Link href="/register" className="w-full bg-[#f79f08] hover:bg-[#d88b06] text-[#231c10] text-xs font-bold py-2 rounded shadow-[0_0_20px_rgba(247,159,8,0.2)] transition-all block">Escolher Pro</Link>
                    </td>
                    <td className="p-5 text-center">
                      <Link href="/register" className="block w-full bg-white/5 hover:bg-white/10 text-white text-xs font-bold py-2 rounded transition-colors">Escolher Empire</Link>
                    </td>
                  </tr>
                </tbody>
              </table>
...
# Find the pattern and insert the table
pattern = r'(\s+</section>\s+)(\{/\* FAQ \*/\})'
new_content = re.sub(pattern, r'\1' + table_section + '\n\n      \\2', content)

# Write the modified content back
with open('src/modules/website/SaasLandingPage.tsx', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Table section added successfully!")
