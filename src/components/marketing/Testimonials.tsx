...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    city: 'São Paulo, SP',
    rating: 5,
    text: 'O BarberGold revolucionou minha barbearia! Antes eu perdia horas com agendas de papel e agora tudo é automático. O sistema de comissões me economiza tempo e evita erros. Recomendo demais!',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Com 5 profissionais, controlar comissões era um pesadelo. Agora com o BarberGold tudo é calculado automaticamente. O agendamento online trouxe muito mais clientes. Melhor investimento que fiz!',
  ...
  },
  {
    ...
    city: 'Curitiba, PR',
    rating: 5,
    text: 'Tenho 3 unidades e o BarberGold permite gerenciar tudo em um só lugar. Relatórios por unidade, controle total de estoque, e a equipe se adaptou super rápido. Sistema profissional de verdade.',
