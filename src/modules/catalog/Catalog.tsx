...
import {
   ...
   Eye, Tag, History, DollarSign, BarChart3, Calculator, ShoppingCart, ArrowRightCircle, TrendingUp, BookOpen
} from 'lucide-react';
...
export const Catalog = () => {
   ...
   // Tab State
   const [activeTab, setActiveTab] = useState<'SERVICES' | 'PRODUCTS' | 'INVENTORY' | 'CATEGORIES' | 'LIBRARY'>('SERVICES');
         ...
         <div className="mb-6 border-b border-zinc-800 overflow-x-auto">
            <div className="flex gap-2 min-w-max">
               <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'SERVICES'
               ...
               <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'PRODUCTS'
                     ? 'border-amber-500 text-white'
                     : 'border-transparent text-zinc-500 hover:text-zinc-300'
                     }`}
               >
               ...
               <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'INVENTORY'
                     ? 'border-amber-500 text-white'
                     : 'border-transparent text-zinc-500 hover:text-zinc-300'
                     }`}
               >
               ...
               <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'CATEGORIES'
                     ? 'border-amber-500 text-white'
                     : 'border-transparent text-zinc-500 hover:text-zinc-300'
                     }`}
               >
               ...
               <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'LIBRARY'
                     ? 'border-amber-500 text-white'
                     : 'border-transparent text-zinc-500 hover:text-zinc-300'
                     }`}
               >
                     ...
                     <div className="flex space-x-2 mb-6 bg-zinc-950 p-1 rounded-lg border border-zinc-800 w-full md:w-max overflow-x-auto">
                        {(['SERVICE', 'PRODUCT', 'SUPPLY', 'SUPPLIER'] as CategoryType[]).map(type => (
                           <button
                              ...
                              className={`px-4 py-2 rounded-md text-xs font-bold transition-all whitespace-nowrap ${categoryType === type ? 'bg-amber-500 text-zinc-900' : 'text-zinc-500 hover:text-white'
                                 }`}
                           >
