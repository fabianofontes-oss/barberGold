...
export const Clients = () => {
  ...
  // --- DATA PREPARATION ---
  // Optimized: Use useMemo to prevent expensive filtering on every render
  ...
  }, [currentUser, clients, activeTab, myLoyalClients, myHistoryClients]);
  ...
  }, [currentUser, displayedClients, searchQuery, shopSettings.hideClientContactInfo]);
  ...
  }, [today, shopSettings.winBackDays, shopSettings.returnReminderDays]);
  ...
  // Validação de segurança - Must be last to avoid hook ordering issues
