...
export const Clients = () => {
  ...
  return (
    <div className="h-full flex flex-col animate-fade-in">
      ...
      {/* Add Client Modal */}
      {isModalOpen && (
        <div role="dialog" aria-modal="true" aria-labelledby="modal-add-client-title" className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900 md:bg-black/70 md:backdrop-blur-sm p-0 md:p-4">
      ...
      {selectedClient && (
        <div role="dialog" aria-modal="true" aria-label="Client Details" className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900 md:bg-black/70 md:backdrop-blur-sm p-0 md:p-4">
