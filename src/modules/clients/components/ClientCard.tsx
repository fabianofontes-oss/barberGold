...
import { Client, ShopSettings, StaffMember } from '@/types';
import { ClientTagsBadges } from './ClientTagsManager';
import { getReturnStatus, getStatusStyles } from '../utils';
...
export const ClientCard = memo(({
  ...
  const returnStatus = getReturnStatus(client.lastVisit, shopSettings);
