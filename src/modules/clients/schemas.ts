...
export const createClientSchema = z.object({
    ...
    // Phone is optional but if provided must match format OR be empty string
    phone: z.string().regex(phoneRegex, 'Telefone deve estar no formato (XX) XXXXX-XXXX').optional().or(z.literal('')),
