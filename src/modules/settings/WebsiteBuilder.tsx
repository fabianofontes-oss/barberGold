...
export const WebsiteBuilder = () => {
         ...
         <div className="h-full flex flex-col items-center justify-center animate-fade-in p-6 text-center">
            <div className="max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
               ...
               <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
                  PersonalizaÃ§Ã£o avanÃ§ada, temas premium e domÃ­nio prÃ³prio (.com.br) estÃ£o disponÃ­veis
                  apenas no plano <span className="text-amber-400 font-bold">ELITE</span>.
               </p>
   ...
   // ... (Keep existing Reorder and Toggle Logic) ...
         ...
         <div className="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
               ...
               <p className="text-zinc-400">
                  Customize sua vitrine digital. Ã‰ isso que seu cliente vÃª antes de agendar.
               </p>
            </div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1 overflow-hidden pb-4">
            ...
            <div className="lg:col-span-2 bg-zinc-900 border border-zinc-800 rounded-2xl flex flex-col overflow-hidden">
               ...
               <div className="flex border-b border-zinc-800 overflow-x-auto">
                  ...
                  >
                     <Palette className="w-3 h-3" /> Tema & Cores
                  </button>
                  <button
               ...
               <div className="p-6 overflow-y-auto flex-1">
                  ...
                  {/* --- CONTENT EDITOR (OMITTED FOR BREVITY - SAME AS BEFORE) --- */}
                  {activeTab === 'CONTENT' && (
                           ...
                           <div className="relative z-10 space-y-6">
                              ...
                              <div>
                                 <div className="flex justify-between items-center mb-2">
                                    <label className="block text-xs font-bold text-zinc-500 uppercase">Link Exclusivo (GrÃ¡tis)</label>
                                    <span className="text-[10px] bg-emerald-500/10 text-emerald-500 px-2 py-0.5 rounded font-bold">ATIVO</span>
                                 </div>
                                 <div className="flex items-center">
                                    <input
                                       ...
                                       className="flex-1 bg-zinc-950 border border-zinc-800 rounded-l-xl py-3 px-4 text-white focus:border-amber-500 outline-none text-lg font-bold font-mono text-right"
                                       placeholder="your-shop-name"
                                    />
                                    <span className="bg-zinc-900 border border-l-0 border-zinc-800 text-zinc-400 px-4 py-3 rounded-r-xl text-lg font-mono">
                                       .barber.gold
                                    </span>
                                 </div>
                              ...
                              <div>
                                 <div className="flex justify-between items-center mb-2">
                                    <label className="block text-xs font-bold text-white uppercase flex items-center gap-2">
                                       DomÃ­nio PrÃ³prio (.com.br) <span className="bg-amber-500 text-zinc-900 text-[9px] px-1.5 rounded font-bold">PRO</span>
                                    </label>
                                 </div>
