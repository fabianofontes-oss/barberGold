                ...
                <tbody className="divide-y divide-white/5 text-sm text-gray-300">
                  ...
                  <tr className="bg-[#18181b]">
                    ...
                    <td className="p-5 text-center border-r border-white/5 bg-[#202024]/50">
                      <Link href="/register" className="block w-full bg-[#f79f08] hover:bg-[#d88b06] text-[#231c10] text-xs font-bold py-2 rounded shadow-[0_0_20px_rgba(247,159,8,0.2)] transition-all">Escolher Pro</Link>
                    </td>
