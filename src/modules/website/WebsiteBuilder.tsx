                              ...
                              <div>
                                 ...
                                 <div className="flex items-center">
                                    <input
                                       ...
                                       className="flex-1 bg-zinc-900 border border-zinc-800 rounded-l-xl py-3 px-4 text-white focus:border-amber-500 outline-none text-sm font-bold font-mono text-right"
                                       placeholder="your-shop-name"
                                    />
                                    <span className="bg-zinc-900 border border-l-0 border-zinc-800 text-zinc-500 px-4 py-3 rounded-r-xl text-sm font-mono">
                                       .barber.gold
                                    </span>
                                 </div>
