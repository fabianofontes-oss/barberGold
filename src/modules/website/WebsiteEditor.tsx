...
export const WebsiteEditor = () => {
   ...
   const siteUrl = `https://${slug}.barber.gold`;
                              ...
                              <div className="flex gap-2">
                                 {['#09090b', '#022c22', '#2e1065', '#0f172a', '#083344'].map(color => (
                                    <button
                                       ...
                                       className={`w-10 h-10 rounded-lg border-2 transition-all relative ${selectedPrimaryColor === color ? 'border-amber-500 ring-2 ring-amber-500/50' : 'border-zinc-700 hover:border-amber-500'
                                          }`}
                              ...
                              <div className="flex gap-2">
                                 {['#f59e0b', '#10b981', '#a855f7', '#0ea5e9', '#ec4899'].map(color => (
                                    <button
                                       ...
                                       className={`w-10 h-10 rounded-lg border-2 transition-all relative ${selectedAccentColor === color ? 'border-white ring-2 ring-white/50' : 'border-zinc-700 hover:border-white'
                                          }`}
                                       style={{ backgroundColor: color }}
                                    >
