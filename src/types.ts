...
export type ViewState = 'DASHBOARD' | 'AGENDA' | 'PDV' | 'CLIENTS' | 'FINANCE' | 'CATALOG' | 'SETTINGS' | 'MY_PLAN' | 'GROWTH' | 'SMART_PRICING' | 'REFERRALS' | 'WEBSITE_EDITOR' | 'SUPER_ADMIN_DASHBOARD' | 'SUPER_ADMIN_TENANTS' | 'SUPER_ADMIN_PLANS' | 'SUPER_ADMIN_PARTNERS' | 'SUPER_ADMIN_SYSTEM' | 'SUPER_ADMIN_SUPPORT' | 'SUPER_ADMIN_BILLING' | 'SUPER_ADMIN_SETTINGS' | 'SUPER_ADMIN_MARKETING' | 'SUPER_ADMIN_MARKETPLACE' | 'SUPER_ADMIN_CMS' | 'SAAS_LANDING' | 'AUTH' | 'ONLINE_BOOKING' | 'TIPS_REVIEW' | 'PUBLIC_WEBSITE' | 'SUPER_OFFICE_V2';
